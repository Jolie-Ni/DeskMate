...
// Builds a Local Observer database from AgentNet trajectories.
//
// Usage: ObserverFixture <derived-dir> <output.sqlite>
//
...
guard args.count == 3 else {
    ...
    usage: ObserverFixture <derived-dir> <output.sqlite>   build a fixture
           ObserverFixture verify <fixture.sqlite>         report what clustering sees
           ObserverFixture analyze <fixture.sqlite> [days] run the real pipeline (spends API credit)
